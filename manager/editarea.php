...
if ($_SESSION['id_manager'] == "") {
    ...
    if (isset($_REQUEST['update_id'])) {
        try {
            $id_area = $_REQUEST['update_id'];
            $select_stmt = $db->prepare('SELECT * FROM area WHERE id_area = :id');
            $select_stmt->bindParam(":id", $id_area);
            $select_stmt->execute();
            ...
            <div class="content-wrapper">
                ...
                <div class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1 class="m-0">Edit Area Page</h1>
                                <hr />
                            </div>
                        </div>
                        <div class="row">
                                ...
                                <div class="card">
                                    <div class="card card-primary">
                                        <div class="card-header">
                                            <h3 class="card-title">Edit Areas</h3>
                                        </div>
                                    </div>
                                    <form action="" method="post" enctype="multipart/form-data">
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                <label for="namearea">ชื่อเเผงลำดับที่</label>
                                                <input type="text" class="form-control" id="namearea" name="namearea" value="<?php echo $namearea; ?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="imgUrl">รูปเเผงร้านค้า </label>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <hr/>
                                                <p>
                                                        <img src="../upload/area/<?php echo $image; ?>" height="100" width="100" alt="">
                                                </p>
                                            </div>
                                        </div>
                                        <!-- /.card-body -->
