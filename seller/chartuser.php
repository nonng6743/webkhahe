                                    ...
                                    if (isset($_REQUEST['sand'])) {
                                        ...
                                        if (empty($message)) {
                                            ...
                                            try {
                                                ...
                                                $stmt->execute();
                                                echo "<script>window.location.href='chartuser.php?user_id=$id_user'</script>";
                                                        ...
                                                        $usermes = '
                                                                    ...
                                                                    <div class="direct-chat-msg">
                                                                        <div class="direct-chat-infos clearfix">
                                                                            <span class="direct-chat-name float-left">' . $firstname = $rowuser['firstname'] . '</span>
                                                                            
                                                                        </div>
                                                                        <img class="direct-chat-img" src="../upload/user/'.$rowuser['image'].'" alt="message user image">
