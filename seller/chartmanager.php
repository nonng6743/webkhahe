...
?>
    ...
    <head>
        ...
        <title>ติดต่อผู้จัดการตลาด</title>
            ...
            <div class="content-wrapper">
                ...
                <div class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1 class="m-0">หน้าติดต่อผู้จัดการตลาด</h1>
                                <hr />
                            </div>
                        </div>
                        <div class="row">
                                ...
                                <div class="card">
                                        ...
                                        if (empty($message)) {
                                            ...
                                            try {
                                               $message = ("INSERT INTO chatmanager(id_seller , message,status ) VALUES ('$id_seller','$message','$status')");
                                                ...
                                                $stmt->execute();
                                                echo "<script>window.location.href='chartmanager.php'</script>";
                                    ...
                                    <div class="card direct-chat direct-chat-warning card-primary"">
                                        <div class="card-header">
                                            <h3 class="card-title">ติดต่อผู้จัดการตลาด</h3>
                                                ...
                                                while ($rowchart = $select_chart->fetch(PDO::FETCH_ASSOC)) {
                                                    ...
                                                    if ($status === 'manager') {
                                                        $usermes = '
                                                                    ...
                                                                    <div class="direct-chat-msg">
                                                                        <div class="direct-chat-infos clearfix">
                                                                            <span class="direct-chat-name float-left">ผู้จัดการตลาด</span>
                                                        ...
                                                        $usermes = '<div class="direct-chat-msg right">
                                                                    <div class="direct-chat-infos clearfix">
                                                                        <span class="direct-chat-name float-right">' . $firstname = $rowshop['nameshop'] . '</span>
